...
<meta name="theme-color" content="#FF3300"><meta name="application-name" content="GoInd">
...
<meta property="og:site_name" content="GoInd">
...
<meta property="og:title" content="GoInd">
<meta property="og:url" content="https://github.com/oghelaaa/GoIndonesia-dark">
<link rel="apple-touch-icon" href="https://i.imgur.com/rOyuGjA.gif"><link rel="icon" type="image/png" sizes="32x32" href="https://i.imgur.com/rOyuGjA.gif">
...
<style>@import url(${themeOptions.cdn}@${themeOptions.version}/GoIND/dist/style.min.css);</style>
...
<body>
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MR47R4M"height="0" width="0" style="display:none;visibility:hidden">
</iframe></noscript>
    <div id="app"></div>
    <script src="${themeOptions.cdn}@${
    themeOptions.version
  }/GoIND/dist/app.min.js"></script>
</body>
</html>
`;
}
  ...
  basicAuthResponse(request) {
    const user = this.root.user || "",
      ...
      _401 = new Response("Unauthorized", {
        headers: {
          "WWW-Authenticate": `Basic realm="GoIND:drive:${this.order}"`,
        },
        status: 401,
      });
    if (user || pass) {
